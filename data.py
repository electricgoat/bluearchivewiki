...
BlueArchiveData = collections.namedtuple(
    ...
    ['characters', 'characters_ai', 'characters_localization', 'characters_skills', 'characters_stats', 'characters_cafe_tags', 
     'costumes',
    'skills', 'skills_localization','skill_additional_tooltip','skill_select_ex_tooltip','translated_characters','translated_skills',
    'weapons', 'gear',
...
def load_data(path_primary, path_secondary, path_translation):
    return BlueArchiveData(
        ...
        skill_select_ex_tooltip =   load_file_grouped(path_primary, 'SkillSelectExTooltipExcelTable.json', key='GroupId'),
        ...
        furniture_template=         load_generic(path_primary, 'FurnitureTemplateExcelTable.json', key="FurnitureTemplateId"),
        furniture_template_element= load_file_grouped(path_primary, 'FurnitureTemplateElementExcelTable.json', key="FurnitureTemplateId"),
        ...
        event_content_dice_race=    load_generic(path_primary, 'EventContentDiceRaceExcelTable.json', key='EventContentId'),
        event_content_dice_race_node= load_file_grouped(path_primary, 'EventContentDiceRaceNodeExcelTable.json', 'EventContentId'),
        event_content_dice_race_total_reward=load_file_grouped(path_primary, 'EventContentDiceRaceTotalRewardExcelTable.json', key='EventContentId'),
        event_content_clue_search=  load_generic(path_primary, 'EventContentClueSearchExcelTable.json', key='EventContentId'),
        event_content_clue_search_reward= load_generic(path_primary, 'EventContentClueSearchRewardExcelTable.json', key='Id'),
        event_content_clue_search_round= load_file_grouped(path_primary, 'EventContentClueSearchRoundExcelTable.json', key='EventContentId'),
        event_content_clue=         load_file_grouped(path_primary, 'EventContentClueExcelTable.json', key='EventContentId'),
